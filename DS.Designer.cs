...
namespace GestionEtudiants {
    ...
    public partial class DS : global::System.Data.DataSet {
        ...
        public partial class EtudiantDataTable : global::System.Data.TypedTableBase<EtudiantRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EtudiantRow AddEtudiantRow(int Id, string name, int age) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EtudiantRow FindById(int Id) {
        ...
        public partial class EtudiantRow : global::System.Data.DataRow {
            ...
            public int Id {
                get {
                    return ((int)(this[this.tableEtudiant.IdColumn]));
                }
                set {
            ...
            public string name {
                get {
                    try {
                        return ((string)(this[this.tableEtudiant.nameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'name\' dans la table \'Etudiant\' est DBNull.", e);
                    }
                }
                set {
                    this[this.tableEtudiant.nameColumn] = value;
                }
            }
            ...
            public int age {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'age\' dans la table \'Etudiant\' est DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsnameNull() {
                return this.IsNull(this.tableEtudiant.nameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetnameNull() {
                this[this.tableEtudiant.nameColumn] = global::System.Convert.DBNull;
            }
...
namespace GestionEtudiants.DSTableAdapters {
    ...
    public partial class EtudiantTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Etudiant] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Etudiant] ([Id], [name], [age]) VALUES (@Id, @name, @age);\r\nSE" +
                "LECT Id, name, age FROM Etudiant WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Etudiant] SET [Id] = @Id, [name] = @name, [age] = @age WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_age = 1 AND [age] IS NULL) OR ([age] = @Original_age)));
SELECT Id, name, age FROM Etudiant WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GestionEtudiants.Properties.Settings.Default.EtudiantsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, age FROM dbo.Etudiant";
        ...
        public virtual int Fill(DS.EtudiantDataTable dataTable) {
        ...
        public virtual DS.EtudiantDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DS.EtudiantDataTable dataTable = new DS.EtudiantDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DS.EtudiantDataTable dataTable) {
